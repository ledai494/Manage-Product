...
<div id="wrapper">
    <!-- Sidebar -->
    <nav id="sidebar" v-show="$route.path=== '/login'||$route.path=== '/register' || $route.path=== '/forget' ? false : true" style="display: none">
        ...
        <li class="nav-item">
            ...
            <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Employee UI</h6>
                    <router-link class="collapse-item" to="/store-employee">Add</router-link>
                    <router-link class="collapse-item" to="/employee">All</router-link>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Suplies</h6>
                    <router-link class="collapse-item" to="/store-supplier">Add</router-link>
                    <router-link class="collapse-item" to="/supplier">All</router-link>
                </div>
            </div>
        ...
        <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <router-link class="collapse-item" to="/store-category">Add</router-link>
                    <router-link class="collapse-item" to="/category">All</router-link>
                </div>
            </div>
        ...
        <li class="nav-item">
                ...
                <div id="collapseProduct" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <router-link class="collapse-item" to="/store-product">Add</router-link>
                        <router-link class="collapse-item" to="/product">All</router-link>
                    </div>
                </div>
        ...
        <li class="nav-item">
                ...
                <div id="collapseExpense" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Expense</h6>
                        <router-link class="collapse-item" to="/store-expense">Add</router-link>
                        <router-link class="collapse-item" to="/expense">All</router-link>
                    </div>
                </div>
        ...
        <li class="nav-item">
                ...
                <div id="collapseCustomer" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <router-link class="collapse-item" to="/store-customer">Add</router-link>
                        <router-link class="collapse-item" to="/customer">All</router-link>
                    </div>
                </div>
        ...
        <li class="nav-item">
                ...
                <div id="collapseSalary" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <router-link class="collapse-item" to="/pay-salary">All salary</router-link>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseorder" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">order</h6>
                        <router-link class="collapse-item" to="/order">Add order</router-link>
                        <router-link class="collapse-item" to="/search-order">order</router-link>
                    </div>
                </div>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <!-- TopBar -->
            <nav v-show="$route.path=== '/login'||$route.path=== '/register' || $route.path=== '/forget' ? false : true" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" style="display: none">

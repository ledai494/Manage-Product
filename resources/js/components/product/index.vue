                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr v-for="product in filtersearch" :key="product.id">
                                ...
                                <td>
                                    <router-link :to="{name:'edit-product', params:{id:product.id}}"  href="#" class="btn btn-sm btn-primary">Edit</router-link>
                                    <a @click="deleteProduct(product.id)" href="#" class="btn btn-sm btn-danger">

                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="supplierInsert" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="text" v-model="form.name" class="form-control"  placeholder="Enter Full Name Supplier">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="text" v-model="form.address" class="form-control"  placeholder="Enter Supplier Address">
                                                    <small class="text-danger" v-if="errors.address">{{errors.address[0]}}</small>
                                                </div>
                                                <div class="col-md-6">
                                                    <input v-model="form.phone" type="text" class="form-control"  aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <input type="text" v-model="form.shopname" class="form-control"  placeholder="Enter Supplier Shop Name">
